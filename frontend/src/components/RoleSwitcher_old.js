...
const RoleSwitcher = () => {
    ...
    console.log('Rendering with:', { hasSwitchedRole, isOnDashboard });

    return (
        <div className={`d-flex align-items-center ${isOnDashboard ? 'dashboard-top-center' : ''}`}>
            <select 
                value={selectedRole} 
